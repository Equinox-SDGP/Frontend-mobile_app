...
import {useAuth0, Auth0Provider} from 'react-native-auth0'; // Import useAuth0 hook from react-native-auth0
import authConfig from '(auth)/auth0-config'; // Import authConfig from auth0-config file
